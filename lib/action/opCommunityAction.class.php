...
//    sfConfig::set('opLeftSideBar', 'communitySideMenu');
//    sfConfig::set('op_gadget_side', 'community');
  ...
  */
  public function executeSearch($request)
  {
    ...
    //count total community category
    
    $a = Doctrine::getTable('Community')->createQuery();
    $this->total_category = $a->count();
