...
<div id="follow-list-box">
  <div class="heading_top follow-list-box-heading">
    <div id="heading_content">Các thành viên quan tâm tới sự kiện</div>
    <div class="clear"></div>
  </div>
    <div id="comment_list">
      <ul class="mf_list_friend clearfix follow_checkin_ul">
        <?php foreach ($list as $follow):?>
          <?php $sender = $follow->getMember();?>
          <li class="bg_le">
            <div class="block02" >
            ...
            <div class="action-member-time"><?php echo date('H\hi d/m/Y', strtotime($follow->getCreatedAt()));?></div>
        </li>
        <?php endforeach;?>
      </ul>
  </div>
