...
class opMessagePluginRouting
{
  static public function listenToRoutingLoadConfigurationEvent(sfEvent $event)
  {
    ...
    $routing->prependRoute('deleteDraftMessage',
      new sfRoute(
        '/message/deleteDraftMessage/:id',
        array('module' => 'message', 'action' => 'delete', 'type' => 'draft'),
        array('id' => '\d+')
      )
    );
    ...
    $routing->prependRoute('suggestMember',
      new sfRoute(
        '/message/suggest',
        array('module' => 'message', 'action' => 'suggest')
      )
    );
  }
}
