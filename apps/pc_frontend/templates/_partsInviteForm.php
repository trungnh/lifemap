...
<?php else: ?>
<form id="invite-form" action="<?php echo $options->getRaw('url') ?>" method="<?php echo $options['method'] ?>"<?php if (!empty($options['isMultipart'])): ?> enctype="multipart/form-data"<?php endif; ?>>
...
<?php slot('form_table') ?>
<table id="invite-table" class="tb-composebox">
...
<?php include_slot('form_table') ?>
   ...
   <!--  </div> -->
<!-- </div> -->
<div id="invite-input-container" class="lm-boxy-footer">
