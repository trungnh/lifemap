  ...
  <div class="dashboard-part">
    <div class="dashboard-part-top">
        <div class="dashboard-title-holder">
            <?php if($is_show_more): ?>
                    <div class="dashboard-part-top-title "><?php echo link_to('Địa điểm nhiều người check-in','@showMore?type=member_checkin_pos') ?></div>
                    <div class="dashboard-part-top-link">
                        <?php echo link_to('Xem thêm ', '@showMore?type=member_checkin_pos'); ?>
                    </div>
            <?php else: ?>
                    <div class="dashboard-part-top-title">Địa điểm nhiều người check-in</div>
            <?php endif;?>
        </div>
        <div class="clear"></div>
    </div>
    <div class="dashboard-part-content" id="pager_show_more_member_checkin_pos_box">
        <div class="dashboard-pager">
           <?php if ($is_show_more): ?>
        <span class="current-page">Trang 1</span>
            <a class="dashboard-next" href="<?php echo url_for('@jqueryShowMore?page=2&type=member_checkin_pos') ?>" id="pager_show_more_member_checkin_pos">&nbsp;</a>
          <?php endif ?>
        </div>
        <ul class="clearfix">
            ...
            <li>
              <div class="db_part_content_v2">
                    ...
                    <div class="right-block">
                      ...
                      <div class="location-address"><?php echo $posCheckin->getNumOfMember().' người check-in'?></div>
                    </div>
                </div>
            </li>
          <?php endforeach;?>
