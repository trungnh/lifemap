  ...
  <div class="dashboard-part">
    <div class="dashboard-part-top">
      <div class="dashboard-title-holder">
        <?php if($is_show_more): ?>
                <div class="dashboard-part-top-title "><?php echo link_to('Nhà cho thuê mới cập nhật trạng thái có','@dashboard_showMore?type=update_rent_house_list') ?></div>
                <div class="dashboard-part-top-link">
                    <?php echo link_to('Xem thêm ', '@dashboard_showMore?type=update_rent_house_list'); ?>
                </div>
        <?php else: ?>
                <div class="dashboard-part-top-title">Nhà cho thuê mới cập nhật trạng thái có</div>
        <?php endif;?>
      </div>
        <div class="clear"></div>
    </div>
    <div class="dashboard-part-content" id="pager_show_more_update_rent_house_box">
        <div class="dashboard-pager">
          <?php if ($is_show_more): ?>
        <span class="current-page">Trang 1</span>
        <a class="dashboard-next" href="<?php echo url_for('@jqueryShowMorePos?page=2&type=update_rent_house') ?>" id="pager_show_more_update_rent_house">&nbsp;</a>
          <?php endif ?>
      </div>
        <ul class="clearfix">
