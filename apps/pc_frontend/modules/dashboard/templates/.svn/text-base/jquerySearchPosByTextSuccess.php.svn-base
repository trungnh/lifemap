    ...
    <div class="dashboard-pager">
        ...
        <?php if ($pager->haveToPaginate()): ?>
            <?php if ($pager->getPage() > 1): ?>
                <a class="dashboard-prev" href="<?php echo url_for('dashboard/jquerySearchPosByText?page=' . $pager->getPreviousPage() . '&keyword=' . $keyword) ?>" id="pager_search_pos_by_text">&nbsp;</a>
            <?php endif; ?>
            <?php if ($pager->getPage() < $pager->getLastPage()): ?>
                <a class="dashboard-next" href="<?php echo url_for('dashboard/jquerySearchPosByText?page=' . $pager->getNextPage() . '&keyword=' . $keyword) ?>" id="pager_search_pos_by_text">&nbsp;</a>
            <?php endif; ?>
        <?php endif; ?>
    </div>
    <ul class="clearfix">
