    ...
    <div class="dashboard-part">
        <div class="dashboard-part-top">
            <div class="dashboard-title-holder">
                <div class="dashboard-part-top-title">Nhà cho thuê </div>
                <div class="dashboard-part-top-link">
                    <?php
                      if ($is_show_more)
                        echo link_to('Xem thêm ', 'dashboard/searchPosRentHouseByText?keyword='.$keyword);
                    ?>
        ...
        <div class="dashboard-part-content" id="pager_search_pos_renthouse_by_text_box">
            <div class="dashboard-pager">
               <?php if ($is_show_more): ?>
                <span class="current-page">Trang 1</span>
                <a class="dashboard-next" href="<?php echo url_for('dashboard/jquerySearchPosRentHouseByText?page=2&keyword='.$keyword) ?>" id="pager_search_pos_renthouse_by_text">&nbsp;</a>
                <?php endif ?>
            </div>
            <ul class="clearfix">
